...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers(HttpMethod.POST, "/v1/auth/tokens").permitAll() /*Login Público*/
            .requestMatchers(HttpMethod.POST,"/v1/end-users","/v1/feature-events","/v1/ai-usages").permitAll()
